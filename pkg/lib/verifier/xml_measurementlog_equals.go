...
func (rule *xmlMeasurementLogEquals) Apply(hostManifest *types.HostManifest) (*RuleResult, error) {
...
func (rule *xmlMeasurementLogEquals) createEventLogFaults(actualMeasurements *ta.Measurement) ([]Fault, error) {

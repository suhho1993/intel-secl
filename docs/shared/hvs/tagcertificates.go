...
// ---
//
// swagger:operation GET /tag-certificates/{tagcertificate_id} TagCertificates RetrieveTagCertificate
// ---
//
// description: |
//   Retrieve a Tag Certificate.
// x-permissions: tag_certificates:retrieve
// security:
//  - bearerAuth: []
// produces:
// - application/json
...
// responses:
//   '200':
//     description: Successfully retrieved the Tag Certificate.
//     content:
//       application/json
//     schema:
//       $ref: "#/definitions/TagCertificate"

...
// HostStatus record represents the connection state of the registered Host with VS. It contains the HostStatusInformation and HostManifest fields.
// swagger:response HostStatus
type HostStatus struct {
	// in:body
	Body hvs.HostStatus
}

// HostStatusCollection represents a collection of HostStatus records.
// swagger:response HostStatusCollection
...
// swagger:operation GET /host-status/{hoststatus_id} HostStatus RetrieveHostStatus
// ---
//
// description: |
...
// ---
//
// swagger:operation GET /host-status HostStatus Search
// ---
//
// description: |
